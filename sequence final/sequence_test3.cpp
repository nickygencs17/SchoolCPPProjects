...
int main( )
{
    sequence * test = new sequence(); // A sequence that will perform tests on
...
// Library facilities used: iostream.h
{
    ...
    cout << " -   Activate the backwards( ) function" << endl;
...
// Library facilities used: iostream
{
   ...
   while( display->_cursor()->link( ) != NULL)//bring the cursor back so current is not null
       display->advance( );
